...
**Dashboard-NG is not finished yet.** Version `0.3.8` is an installable alpha
...
- Current adapter version: `0.3.8`
- Current GitHub tag: `v0.3.8`
...
Wichtig: Dieses Projekt ist noch nicht fertig. Version `0.3.8` ist eine
